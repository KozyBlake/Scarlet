...
public enum GroupAuditTypeEx implements DEnum.DEnumString<GroupAuditTypeEx>
{
    ...
    LIVE_PLAYERLIST             ("groupex.instance.playerlist"         , "Live Player List"              , 0x00_007F7F),
    ...
    WATCHED_MODERATION          ("groupex.watched.mod"                 , "Watched Moderation"            , 0x00_FF7F7F),
    ACTION_FAIL                 ("groupex.action.fail"                 , "Action Failure"                , 0x00_FF0000),
    ;
